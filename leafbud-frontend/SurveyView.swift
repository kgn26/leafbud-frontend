...
class SurveyData: ObservableObject {
    ...
    @Published var lightPref: String = ""
    @Published var size: String = ""
    @Published var hasPets: Bool = false
}

struct SurveyView: View {
    @StateObject var surveyData: SurveyData = SurveyData()
        ...
        NavigationStack {
            ...
            ZStack {
                ...
                VStack(spacing: 20) { // Add spacing between elements
                    ...
                    NavigationLink(destination: SurveyViewOne(surveyData: surveyData)) { // This will navigate to SurveyView
